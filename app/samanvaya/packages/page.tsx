...
const FaqAccordion = () => {
  ...
  const faqs = [
    ...
    { q: "What's not included?", a: "International flights to and from Sri Lanka, travel insurance, personal spending, and any optional post-retreat add-on programs." },
    { q: "How many days is the journey?", a: "South Island and Central Heritage are 8 days each. Whole Island Immersion is the full 14-day circuit covering both routes." },
    { q: "What should I bring?", a: "Comfortable clothing, walking shoes, a water bottle, and any personal essentials. See the \"Before you go\" section above for the full list." },
    { q: "Is transportation included?", a: "Yes, private transportation between all destinations on your chosen route is included in the package price." },
    { q: "Can I customize my journey?", a: "The three package routes are fixed to keep group logistics smooth, but you're welcome to contact us to discuss specific needs before booking." },
    { q: "What's the cancellation policy?", a: "Please contact us for cancellation and refund details." }
  ];
...
export default function PackagesPage() {
  ...
  return (
    <div className="min-h-screen pt-[120px] pb-24 bg-[#FCF6F0]">
      {/* Load PayPal Script */}
      <Script 
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 md:p-8 bg-black/60 backdrop-blur-sm">
          <div className="bg-white rounded-3xl w-full max-w-xl relative flex flex-col max-h-[85vh]">
            ...
            <div className="p-8 md:p-10 overflow-y-auto">
              <h2 className="font-display text-3xl text-deepAmber mb-2">Reserve Your Spot</h2>
              <p className="font-sans text-sm text-[#5a4a3a] mb-8">
              ...
              <div className="space-y-5 mb-8">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-[#FCF6F0] border-none rounded-xl px-5 py-3 font-sans text-sm focus:ring-2 focus:ring-mandarin outline-none"
