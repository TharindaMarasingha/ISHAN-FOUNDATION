    ...
    <section className="relative min-h-[60vh] md:min-h-[70vh] flex flex-col justify-end pb-24 pt-32 px-6 overflow-hidden bg-surface border-b border-divider">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full flex flex-col items-start">
        <motion.span
          ...
          className="inline-block px-4 py-1.5 border border-deepAmber/30 rounded-full font-sans text-[0.65rem] uppercase tracking-[0.2em] text-heading mb-8"
        >
        ...
        <motion.p
          ...
          className="font-sans font-light text-heading max-w-2xl leading-relaxed mb-8"
        >
