...
export function Hero() {
  return (
    <section className="relative min-h-[50vh] md:min-h-[60vh] flex flex-col justify-end pb-24 pt-32 px-6 overflow-hidden bg-deepAmber/[0.03] border-b border-burntOrange/10">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full flex flex-col items-start">
        ...
        >
          Antahakarana<br />
          <span className="text-mandarin">Avalokana</span>
        </motion.h1>
