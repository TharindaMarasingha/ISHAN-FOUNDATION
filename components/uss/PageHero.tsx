  ...
  return (
    <section className="relative min-h-[60vh] flex flex-col justify-end pb-24 pt-32 px-6 overflow-hidden border-b border-divider">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full flex flex-col items-start">
        ...
        >
          Dedicated to the systematic exploration of consciousness, contemplative traditions, and the science of inner development.
        </motion.h2>
        ...
        >
          Universal Spiritual Science acts as the educational and research hub of ISHAN. We treat the human spirit not as an abstract mystery, but as a domain of rigorous inquiry. By uniting empirical scientific methodology with millennia of experiential wisdom, we seek to uncover the universal ethics and philosophical foundations that lead to a conscious, enlightened society.
        </motion.p>
      </div>
    </section>
  );
