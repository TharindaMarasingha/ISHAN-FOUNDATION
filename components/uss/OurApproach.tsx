        ...
        <div className="flex flex-col space-y-8">
          ...
          <RevealOnScroll delay={0.4}>
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <div className="flex-1 p-6 border-l-2 border-[#1B4332] bg-[#1B4332]/5">
                <h4 className="font-display text-xl text-deepAmber mb-2">First-Person Inquiry</h4>
                <p className="font-sans font-light text-sm text-deepAmber/80">Direct, disciplined observation of consciousness through meditation and introspection.</p>
              </div>
              <div className="flex-1 p-6 border-l-2 border-sacredGold bg-sacredGold/5">
                <h4 className="font-display text-xl text-deepAmber mb-2">Third-Person Analysis</h4>
                <p className="font-sans font-light text-sm text-deepAmber/80">Neurological, biological, and psychological mapping of contemplative states.</p>
              </div>
            </div>
          </RevealOnScroll>
        </div>
