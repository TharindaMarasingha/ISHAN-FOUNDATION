  ...
  return (
    <section className="py-24 px-6 max-w-5xl mx-auto text-center">
      ...
      <RevealOnScroll delay={0.4}>
        <p className="font-sans font-light text-xl text-heading leading-relaxed max-w-3xl mx-auto">
...
export function TrainingSection() {
  return (
    <section className="py-24 px-6 bg-heading text-center overflow-hidden relative">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <h2 className="font-display font-light text-4xl md:text-5xl text-secondary mb-12">Training & Certification</h2>
        
        <RevealOnScroll delay={0.2}>
          <div className="flex flex-col gap-6 text-white font-sans font-light text-lg leading-relaxed mb-16 text-left md:text-center px-4 md:px-8">
        ...
        <RevealOnScroll delay={0.4}>
          <div className="pt-16 border-t border-divider">
            <p className="font-display italic text-3xl md:text-4xl text-secondary leading-relaxed max-w-3xl mx-auto">
